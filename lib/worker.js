                            ...
                            , function (res){
                                if(res.ok){
                                  if(_.isUndefined(data.Ready)){
                                    ...
                                    mem.set([mpid, "exchange", key, "Ready", "value"], false, function (err){
                                      if(res.ok){
                                        log.info(ro
                                                , "reset exchange." + key + ".Ready.value to false" );
                                        mem.publish("exchange", [mpid,"exchange", key, "Ready", "value"], function (err){
                                          log.info(ro
