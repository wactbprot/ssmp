...
var load  = function(mp, path){
 ...
 //
 //     console.log(mp.recipe.get(path))
 //     if(_.isEmpty(mp.recipe.get(path))){
 //       protask = {};
 //     }else{
 //       protask = mp.recipe.get(path);
 //     }
 //
 //     // Taskname beginnt mit >>COCO<<
 //     // d.h. in diesem if-Zweig
 //     // wird load rekursiv aufgerufen
 ...
 //       protask.Id = cid;
 //     }
 //     opts.body   = protask; // immer alles mitschicken
 //     opts.method = "POST";
 //
 //     // here we go:
 //     log.info({ok:true}, "try loading " + protask.TaskName)
