        ...
        mp.recipe.set([no], [], function(res){
          if(res.ok){
            mp.definition.get([no], function(def){
              ...
              def = insert_cst(mp, def, calibobjs);
              def = insert_par(mp, def, calibobjs);
              def = insert_seq(mp, def, calibobjs);
...
var insert_cst = function(mp, def, calibobjs){
  var mpname  = mp.name
    , NseqDef = def.length
    , seqDef
    , parDef;
...
var insert_par = function(mp, def, calibobjs){
  var mpname  =  mp.name
    , NseqDef = def.length
    , seqDef
    , parDef;
...
var insert_seq = function(mp, def, calibobjs){
  var mpname  = mp.name
    , NseqDef = def.length
    , seqDef
    , parDef
