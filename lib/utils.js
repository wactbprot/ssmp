...
/**
 * Ersetzt c2.Replace[*] in c1 -- durch replace_in_with() ers.
 * @method repl
 * @param {Object} c1
 * @param {Object} c2
 * @return c
 */
var replace = function(c1, c2){

  var strcont = JSON.stringify(c1)
  for(var j in c2.Replace){
    var patt = new RegExp( j ,"g");
    strcont  = strcont.replace(patt, c2.Replace[j]);
  }

  return JSON.parse(strcont);
}
